...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .week-grid { display: flex; flex-wrap: wrap; gap: 3px; margin-top: 6px; }
        .week-dot { width: 14px; height: 14px; border-radius: 3px; font-size: 7px; display: flex; align-items: center; justify-content: center; font-weight: bold; }
        ...
        <div class="card">
            ...
            <div class="week-grid">
                @for ($w = 1; $w <= 45; $w++)
                    ...
                    <div class="week-dot {{ $isPaid ? 'paid' : 'unpaid' }}">{{ $w }}</div>
                @endfor
            </div>
        </div>
