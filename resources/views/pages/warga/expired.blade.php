<x-layouts::warga :title="__('Link Kedaluwarsa')">
    <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 max-w-sm w-full">
            ...
            <h1 class="text-lg font-bold text-gray-900 mb-2">{{ __('Link Kedaluwarsa') }}</h1>
